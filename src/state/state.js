...
export const state = [
    ...
    paragraph: ["В основном ремонт электроинструмента. Обслуживание сварочного оборудования, кабелей, трехфазных переносок.",
        "Иногда даже приходилось производить легкий ремонт промышленного рентгеновского аппарата `Памир-300`", 
    ...
    paragraph: ["Выезд к абоненту. Диагностика и устранение различных повреждений.", "Приходилось настраивать различное оборудование. Перепрошивать роутеры, настраивать абонентский ПК. Решать проблемы: с драйверами, вирусными ОС, сломанным `железом`, конфликтными клиентами", 
    "Обслуживал избирательные участки. Обеспечивал бесперебойный интернет канал. Производил монтаж и настройку видеонаблюдения."] },
